...
> Use [`PLANO.md`](../../PLANO.md) como fonte de verdade do produto.
...
- Detalhes, fases e critérios de aceite estão em [`PLANO.md`](../../PLANO.md).
...
As unidades executáveis, dependências, edge cases, critérios de aceite e ordem de commits estão em `W01-W04` e `FUP01-FUP04` no [`PLANO.md`](../../PLANO.md).
